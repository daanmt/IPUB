...
**Causas maternas:**
- Doenças sistêmicas: DM, hipotireoidismo, LES, trombofilias
- Infecções: TORCH, listéria, gonorreia
- Distúrbios uterinos: miomas, sinéquias (Sd. Asherman), malformações, incompetência istmocervical (IIC)
- Fatores ambientais: tabaco, álcool, drogas

### 1.3 Formas Clínicas

**Ameaça de abortamento:**
- Sangramento intermitente em pequena quantidade
- Cólicas leves
...
- Cólicas intensas
- Colo **aberto** (pérvio)
- USG: saco gestacional baixo ou descolamento ovular

**Abortamento incompleto:**
- Sangramento intermitente
- Colo geralmente pérvio
- USG: material amorfo e heterogêneo; espessura endometrial (EE) > 15 mm

**Abortamento completo:**
- Sangramento diminui após expulsão
- Colo fecha poucas horas após expulsão completa
- USG: EE ≤ 15 mm (endométrio fino)
...
- Sangramento discreto, podendo ser purulento
- Febre + sinais sistêmicos
- Colo pérvio e **doloroso à mobilização**
- USG: restos ovulares, endométrio irregular

### 1.4 Critérios USG de Gestação Não Evolutiva

- Embrião com CCN **≥ 7 mm** sem atividade cardíaca
- Saco gestacional com diâmetro médio **≥ 25 mm** sem embrião
- Ausência de embrião com BCF após **2 semanas** de USG que evidenciou SG sem vesícula vitelínica
- Ausência de embrião com BCF **11 dias** após USG com vesícula vitelínica presente
...
- ⭐ **Misoprostol** (1ª opção medicamentosa) ou **AMIU** (preferido à curetagem)
- Conduta expectante se paciente estável e sangramento pequeno
- Decisão compartilhada com a paciente

**Abortamento retido:**
- Conduta ativa (misoprostol + AMIU) ou expectante **até 4 semanas**
- Decisão compartilhada com a paciente
...
**AMIU:**
- Técnica de escolha nas gestações **até 12 semanas**
- Mais segura que curetagem (não "raspa" o endométrio)

**Curetagem uterina:**
- ⚠️ Não é técnica de primeira escolha; risco de perfuração e sinéquias (Sd. Asherman)
- Indicada se > 12 semanas ou material muito abundante
- ⚠️ Após a 12ª semana: induzir com misoprostol primeiro, aguardar expulsão, depois curetagem

**Imunoglobulina anti-D:** obrigatória em todas as gestantes **Rh negativo** em qualquer forma de abortamento
...
- Dor em cólicas, quadro clínico pouco esclarecedor
- Reação de Arias-Stella: reação endometrial fisiológica à presença de tecido corial ectópico

**Gestação ectópica ROTA:**
- ⭐ Dor **sincopal e lancinante**
- Choque hipovolêmico **sem sangramento visível externamente**
- Sinal de Laffont: dor escapular (irritação diafragmática pelo hemoperitônio)
- Sinal de Proust (grito de Douglas): dor intensa no fundo de saco posterior
- Sinal de Cullen: equimose periumbilical

⭐ **Sinais de choque hipovolêmico no 1º trimestre = Laparotomia exploradora de emergência**
...
- β-hCG **< 5.000 mUI/mL**
- Massa anexial **< 4 cm** (Zugaib) / < 3,5 cm (FEBRASGO)
- **Sem BCF** (embrião vivo: MTX local com cloreto de potássio)
- Gestação ectópica **íntegra** + estabilidade hemodinâmica
- Desejo de gravidez futura + consentimento informado
...
⭐ Proliferação anormal e desordenada do **tecido trofoblástico placentário**
...
- Marcador p57: **presente** (expressão do alelo materno)
- Risco de NTG: **5%**
...
- USG: imagem vesicular em "cachos de uva" com múltiplas áreas anecoicas
- β-hCG: muito elevado
...
- ⭐ **Método de escolha: Aspiração a Vácuo (AMIU)**
- ⚠️ Curetagem: não é primeira escolha (risco de perfuração)
- ⚠️ **Não usar misoprostol** para esvaziamento molar
- Histerectomia: pacientes sem desejo de gestação futura

Imunoglobulina anti-D: todas as pacientes **Rh negativo**
...
## 4. Resumo de Condutas Rápidas

**Ameaça de abortamento:** repouso + analgesia; não indicar progesterona

**Abortamento retido:** misoprostol + AMIU ou expectante por até 4 semanas (decisão compartilhada)

**Abortamento infectado:** ATB IV + esvaziamento imediato (não esperar melhora)

**GE íntegra, β-hCG < 2.000 em queda:** conduta expectante

**GE íntegra com critérios para MTX:** MTX 50 mg/m² IM dose única

**GE rota / choque hipovolêmico:** laparotomia de emergência imediata

**Mola hidatiforme:** aspiração a vácuo + seguimento semanal do β-hCG
